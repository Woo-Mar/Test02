...
public class GrowthExperienceOfficer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            descriptionText.text = "亲爱的村民，欢迎来到港头村种植园！玩家需要先去西边寻找出口体验作物成长，" +
                                  "完成挑战后会获得作物种子噢！\r\n目前这里只有一块已开垦的土地，你需要通过种植作物才能通关哦，有需要的物品可以在商店进行购买！如果金币不足，可以前往作物售卖店出售作物换取金币。\r\n按E键收获作物后，点击铲子铲除杂草，土地将进入60秒休耕状态，休耕结束后便可继续种植。对了，夜晚会有大量害虫出没，请多加小心！每消灭一只害虫，都能获得金币奖励。\r\n赚取更多金币，开垦更多土地，种植更多作物，最后就能找到路口，去经营你的咖啡馆啦！";
        }
