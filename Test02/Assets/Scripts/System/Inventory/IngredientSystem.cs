...
public class IngredientSystem : MonoBehaviour
{
    ...
    [Header("原料库存")]
    public Ingredient coffeeBeans = new Ingredient { id = "coffee", name = "咖啡豆", currentAmount = 0, unit = "g" };
    public Ingredient milk = new Ingredient { id = "milk", name = "牛奶", currentAmount = 0, unit = "ml" };
    public Ingredient strawberry = new Ingredient { id = "strawberry", name = "草莓酱", currentAmount = 0, unit = "g" };
    public Ingredient carambola = new Ingredient { id = "carambola", name = "杨桃片", currentAmount = 0, unit = "片" };
    public Ingredient fig = new Ingredient { id = "fig", name = "无花果干", currentAmount = 3, unit = "个" };
    public Ingredient ice = new Ingredient { id = "ice", name = "冰块", currentAmount = 0, unit = "块" };
    public Ingredient cup = new Ingredient { id = "cup", name = "杯子", currentAmount = 3, unit = "个" };
